...
## Check for bare words that are now reserved
...
Puppet 4 bundles its own copy of Ruby 2.x, which uses a different regex engine from Ruby 1.8.7. If you were using Ruby 1.8.7 with Puppet, check your regular expressions to ensure that they still behave as intended.
