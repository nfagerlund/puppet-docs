...
You can also put define statements in [the site manifest][sitedotpp]. If you do so, they can be placed anywhere in the file and are not evaluation-order dependent.
