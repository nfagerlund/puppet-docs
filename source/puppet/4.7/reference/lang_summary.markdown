...
Puppet always begins compiling with the **main manifest,** which can be either a single file or a directory of files. (Some sources also call this the "site manifest"). See [the reference page on the main manifest][site_manifest] for details about this special file/directory.
